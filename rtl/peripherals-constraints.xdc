...
create_clock -add -name ext_clk -period 10.00 -waveform {0 5} [get_ports { ext_clk }];

# Create clocks for the PLL outputs
set_clock_groups -group clk_100_peripheral_clk_div -group spi_clk_peripheral_clk_div -group ext_clk -group clkfbout_peripheral_clk_div -asynchronous
...
set_property -dict { PACKAGE_PIN T10   IOSTANDARD LVCMOS33 } [get_ports { blinky }]; #IO_L24N_T3_A00_D16_14 Sch=led[7]
set_property -dict { PACKAGE_PIN T9    IOSTANDARD LVCMOS33 } [get_ports { accel_status_led }]; #IO_L24P_T3_A01_D17_14 Sch=led[6]
...
## Pmod Header JA
set_property -dict { PACKAGE_PIN G13   IOSTANDARD LVCMOS33 } [get_ports { accel_pmod_cs }]; #IO_0_15 Sch=ja[1]
set_property -dict { PACKAGE_PIN B11   IOSTANDARD LVCMOS33 } [get_ports { accel_pmod_mosi }]; #IO_L4P_T0_15 Sch=ja[2]
set_property -dict { PACKAGE_PIN A11   IOSTANDARD LVCMOS33 } [get_ports { accel_pmod_miso }]; #IO_L4N_T0_15 Sch=ja[3]
set_property -dict { PACKAGE_PIN D12   IOSTANDARD LVCMOS33 } [get_ports { accel_pmod_sck }]; #IO_L6P_T0_15 Sch=ja[4]
...
## USB-UART Interface
set_property -dict { PACKAGE_PIN D10   IOSTANDARD LVCMOS33 } [get_ports { ftdi_uart_tx }]; #IO_L19N_T3_VREF_16 Sch=uart_rxd_out
set_property -dict { PACKAGE_PIN A9    IOSTANDARD LVCMOS33 } [get_ports { ftdi_uart_rx }]; #IO_L14N_T2_SRCC_16 Sch=uart_txd_in
