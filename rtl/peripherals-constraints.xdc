...
create_clock -period 10.000 -name ext_clk -waveform {0.000 5.000} -add [get_ports ext_clk]

# Create clocks for the PLL outputs
create_clock -period 200.000 -name spi_clk -waveform {0.000 100.000} -add [get_nets spi_clk]
set_clock_groups -name async_clocks -asynchronous -group [get_clocks ext_clk] -group [get_clocks spi_clk] -group [get_clocks -of_objects [get_pins clk_splitter/inst/mmcm_adv_inst/CLKOUT0]] -group [get_clocks -of_objects [get_pins clk_splitter/inst/mmcm_adv_inst/CLKFBOUT]] -group [get_clocks -of_objects [get_pins clk_splitter/inst/mmcm_adv_inst/CLKOUT1]]
...
set_property -dict {PACKAGE_PIN T10 IOSTANDARD LVCMOS33} [get_ports blinky]
set_property -dict {PACKAGE_PIN T9 IOSTANDARD LVCMOS33} [get_ports accel_status_led]
...
## Pmod Header JA
set_property -dict {PACKAGE_PIN G13 IOSTANDARD LVCMOS33} [get_ports accel_pmod_cs]
set_property -dict {PACKAGE_PIN B11 IOSTANDARD LVCMOS33} [get_ports accel_pmod_mosi]
set_property -dict {PACKAGE_PIN A11 IOSTANDARD LVCMOS33} [get_ports accel_pmod_miso]
set_property -dict {PACKAGE_PIN D12 IOSTANDARD LVCMOS33} [get_ports accel_pmod_sck]
...
## USB-UART Interface
set_property -dict {PACKAGE_PIN D10 IOSTANDARD LVCMOS33} [get_ports ftdi_uart_tx]
set_property -dict {PACKAGE_PIN A9 IOSTANDARD LVCMOS33} [get_ports ftdi_uart_rx]
...
set_property -dict { PACKAGE_PIN F16   IOSTANDARD LVCMOS33 SLEW SLOW DRIVE 12} [get_ports { eth_mdc }]; #IO_L14N_T2_SRCC_15 Sch=eth_mdc
set_property -dict { PACKAGE_PIN K13   IOSTANDARD LVCMOS33 SLEW SLOW DRIVE 12} [get_ports { eth_mdio }]; #IO_L17P_T2_A26_15 Sch=eth_mdio
set_property -dict { PACKAGE_PIN G18   IOSTANDARD LVCMOS33 SLEW SLOW DRIVE 12} [get_ports { eth_ref_clk }]; #IO_L22P_T3_A17_15 Sch=eth_ref_clk
create_clock -period 40.000 -name ext_clk -waveform {0.000 20.000} -add [get_ports eth_ref_clk]

set_property -dict { PACKAGE_PIN C16   IOSTANDARD LVCMOS33 SLEW SLOW DRIVE 12} [get_ports { eth_rstn }]; #IO_L20P_T3_A20_15 Sch=eth_rstn
set_property -dict { PACKAGE_PIN F15   IOSTANDARD LVCMOS33 } [get_ports { eth_rx_clk }]; #IO_L14P_T2_SRCC_15 Sch=eth_rx_clk
create_clock -period 40.000 -name ext_clk -waveform {0.000 20.000} -add [get_ports eth_rx_clk]
...
create_clock -period 40.000 -name ext_clk -waveform {0.000 20.000} -add [get_ports eth_tx_clk]
